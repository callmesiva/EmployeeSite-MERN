...
const Login = () => {
  ...
  //if user logged in user can't see login page without logout
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      >
        ...
        {isLoading ? (
          <button className="bg-lime-600 hover:bg-lime-700text-white font-bold py-2 px-4 rounded w-full">
            <svg
              aria-hidden="true"
              role="status"
          ...
          <button
            className="bg-lime-600 hover:bg-lime-700 text-white font-bold py-2 px-4 rounded w-full"
            type="submit"
          >
            Login
          </button>
      ...
      <div>
        <button
          className="border-2 border-lime-600 bg-lime-200 h-10 w-64 rounded-md"
